...
/// <param name="Reasons">The detailed reasons reported by the server when unhealthy.</param>
/// <param name="QuotaStates">The quota states reported by the server.</param>
public sealed record MilvusHealthState(
    bool IsHealthy,
    string Reason,
    MilvusErrorCode ErrorCode,
    IReadOnlyList<string>? Reasons = null,
    IReadOnlyList<QuotaState>? QuotaStates = null);
