...
/// <summary>
/// Represents a request to revoke a privilege from a role using the v2 object/privilege model.
/// </summary>
public sealed class RevokePrivilegeReqV2
{
    /// <summary>
    /// The name of the role from which the privilege is revoked.
    /// </summary>
    public string RoleName { get; set; } = "";

    /// <summary>
    /// The privilege to revoke, e.g. <c>"Search"</c> or <c>"CreateIndex"</c>.
    /// </summary>
    ...
    internal Grpc.OperatePrivilegeV2Request ToGrpcRequest()
    {
        ...
        // The server (validateOperatePrivilegeV2Params) rejects an empty collection name; fail fast.
