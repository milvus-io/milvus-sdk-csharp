...
/// </summary>
/// <remarks>
/// <para><b>Purpose:</b> show how to declare a nullable column with a default value, then insert rows that
/// carry an explicit null (stored as NULL) and rows with a value.</para>
