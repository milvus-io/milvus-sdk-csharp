...
internal static class Program
{
    public static async Task<int> Main(string[] args)
    {
        ...
        var examples = new Dictionary<string, Func<string, Task>>
        {
            ...
            [nameof(FullTextSearchExample)] = FullTextSearchExample.Run,
            [nameof(HybridSearchExample)] = HybridSearchExample.Run,
            [nameof(RankerExample)] = RankerExample.Run,
            [nameof(IteratorExample)] = IteratorExample.Run,
            [nameof(DefaultValueExample)] = DefaultValueExample.Run,
            [nameof(FilterTemplateExample)] = FilterTemplateExample.Run,
            [nameof(DBExample)] = DBExample.Run,
            [nameof(NullableVectorExample)] = NullableVectorExample.Run,
            [nameof(MultiAnalyzerExample)] = MultiAnalyzerExample.Run,
            [nameof(GeometryExample)] = GeometryExample.Run,
            [nameof(StructExample)] = StructExample.Run,
            [nameof(TimestampExample)] = TimestampExample.Run,
            [nameof(OptimizeExample)] = OptimizeExample.Run,
            [nameof(CDCExample)] = CDCExample.Run,
            [nameof(HighlighterExample)] = HighlighterExample.Run,
            [nameof(TLSExample)] = TLSExample.Run
        };
