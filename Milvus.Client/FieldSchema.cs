...
public sealed class FieldSchema
{
    ...
    public static FieldSchema Create(
        ...
        string description = "")
        => new(name, dataType, nullable, isPrimaryKey, autoId, isPartitionKey, defaultValue, description);
    ...
    public static FieldSchema CreateVarchar(
        ...
        string description = "")
        => new(name, MilvusDataType.VarChar, nullable, isPrimaryKey, autoId, isPartitionKey, defaultValue, description)
        {
            MaxLength = maxLength
        };
    ...
    public static FieldSchema CreateArray<TData>(
        ...
        bool nullable = false,
        string description = "")
        => new(name, MilvusDataType.Array, nullable, defaultValue: null, description: description)
        {
