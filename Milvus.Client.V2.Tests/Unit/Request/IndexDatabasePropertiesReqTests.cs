...
{
    [Fact]
    public void AlterIndexProperties_maps_extra_params()
    {
        ...
        Assert.Empty(grpc.DeleteKeys);
    }

    [Fact]
    public void AlterIndexProperties_maps_delete_keys()
    {
        var request = new AlterIndexPropertiesReq
        {
            CollectionName = "book",
    ...
    [Fact]
    public void AlterIndexProperties_rejects_combining_properties_and_delete_keys()
    {
    ...
    {
        var request = new AlterIndexPropertiesReq { CollectionName = "book" };
        request.Properties["mmap.enabled"] = "true";
        Grpc.AlterIndexRequest grpc = request.ToGrpcRequest();
