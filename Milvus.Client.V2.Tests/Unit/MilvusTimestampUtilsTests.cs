...
public class MilvusTimestampUtilsTests
{
    ...
    [Fact]
    public void FromDateTime_rejects_pre_epoch_dates()
    {
        var preEpoch = new DateTime(1969, 12, 31, 23, 59, 59, DateTimeKind.Utc);

        Assert.Throws<ArgumentOutOfRangeException>(() => MilvusTimestampUtils.FromDateTime(preEpoch));
    }
